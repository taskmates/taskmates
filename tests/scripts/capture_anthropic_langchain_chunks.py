"""Script to capture Anthropic LangChain streaming chunks and save them to a JSONL fixture file."""
import asyncio
import json
...
async def capture_streaming_chunks():
    """Capture streaming chunks from Anthropic LangChain and save to fixture file."""
    ...
    fixture_path = fixtures_dir / "anthropic_streaming_response.jsonl"
    ...
    non_streaming_path = fixtures_dir / "anthropic_non_streaming_response.json"
