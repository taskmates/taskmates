...
#     objective = Objective(key=ObjectiveKey(outcome="test_runner"))
#     run = Transaction(
#         objective=objective,
...
#     sub_objective = objective.get_or_create_sub_objective("manual_cache", inputs)
#     sub_objective.result_future.set_result(42)
#
...
#     objective = run.objective
#     sub_objective = objective.get_or_create_sub_objective("purpose_cache", None)
#     sub_objective.result_future.set_result(42)
#
